...
def grpo_train_epoch(
    ...
    for step, batch in enumerate(loader, start=start_step + 1):
        prompts = batch['prompt']  # list[str], length Bo
        ...
        std_r = grouped_rewards.std(dim=1).repeat_interleave(args.num_generations)  #[B*n]
        ...
        kl_div = ref_per_token_logps - per_token_logps  #[B*n , R]
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="NanoMind GRPO (Group Relative Policy Optimization)")
    ...
    parser.add_argument("--wandb_project", type=str, default="NanoMind-GRPO", help="wandb项目名")
    ...
    lm_config = NanoMindConfig(hidden_size=args.hidden_size, num_hidden_layers=args.num_hidden_layers,
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"NanoMind-GRPO-Epoch-{args.epochs}-BS-{args.batch_size}-LR-{args.learning_rate}"
